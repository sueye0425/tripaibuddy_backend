...
class TestSanDiegoItinerary:
    ...
    def test_restaurant_descriptions_quality(self):
        """Test that restaurant descriptions are properly enhanced by Google Places API"""
        ...
        for restaurant in restaurants_found:
            ...
            assert description, f"Restaurant '{name}' should have a description"
            assert len(description) > 10, f"Restaurant '{name}' description should be substantial"
    ...
    def test_complete_itinerary_endpoint_validation(self):
        ...
        assert description_quality_passed > 0, "At least one restaurant should have quality descriptions"
...
if __name__ == "__main__":
    ...
    try:
        ...
        test_instance.test_restaurant_descriptions_quality()
        print("✅ Restaurant descriptions test passed")
