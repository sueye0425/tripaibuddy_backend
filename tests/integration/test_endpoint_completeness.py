...
class TestEndpointCompleteness:
    ...
    def _validate_restaurant_completeness(self, restaurant_block):
        ...
        # Restaurants no longer have descriptions - check other essential data instead
        assert restaurant_block.get("name"), "Restaurant must have name"
        ...
        # Description quality check
        # Restaurants no longer have descriptions - check website instead
        website = restaurant_block.get("website")
        # Website is optional but preferred for restaurant info
